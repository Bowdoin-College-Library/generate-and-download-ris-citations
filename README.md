# Generate and Download RIS or PDF Citations
...
Once applied, the script gathers the matching requests, retrieves the relevant metadata, and formats it for easy export. Citations can be downloaded in either **.ris** or **.pdf** format.

- **.ris files** can be imported into Zotero, EndNote, or any other citation management tool.
- **.pdf files **are formatted following APA guidelines.

Currently, the **.pdf** file option is only formatting English Language characters. For foreign language citations, we recommend the **.ris** option.
